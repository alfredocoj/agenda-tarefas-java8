...
import br.uema.engcomp.exceptions.NotImplementedException;
import br.uema.engcomp.models.Tarefa;
import br.uema.engcomp.models.Usuario;
import br.uema.engcomp.models.query.QTarefa;
...
public class JFrameTarefas extends JFrame{
    /**
    ...
    private void initComponents() {
        ...
        tarefaList = java.beans.Beans.isDesignTime() ? java.util.Collections.emptyList() : org.jdesktop.observablecollections.ObservableCollections.observableList(new QTarefa().idUsuario.id.equalTo(this.usuario.getId()).findList()); // tarefaQuery.getResultList()
        ...
        columnBinding.setColumnClass(Usuario.class);
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(rootPane, "Confirma a exclusão deste registro?") == JOptionPane.OK_OPTION) {
            try {
                Tarefa tarefa = new QTarefa().id.equalTo(Integer.valueOf(this.jTextFieldId.getText())).findOne(); // Cria o objeto
                if (tarefa.delete()) { // Exclui o objeto do BD
    ...
    private void jButtonCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCancelarActionPerformed
        ...
        try {
            if (this.estado == Estado.INSERINDO) {
                ...
                Tarefa tarefa = new QTarefa().id.equalTo(Integer.valueOf(this.jTextFieldId.getText())).findOne();
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        try {
            ...
            if (this.estado == Estado.INSERINDO) {
                ...
                tarefa.setData(data.parse(this.jFormattedTextFieldData.getText()));
                ...
                if (Optional.ofNullable(new QTarefa().
                        id.
                        equalTo(Integer.valueOf(this.jTextFieldId.getText())).
                        findOne()).
                        isPresent()) {
    ...
    private java.util.List<Tarefa> tarefaList;
